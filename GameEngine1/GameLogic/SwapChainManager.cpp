...
void SwapChainManager::cleanupSwapChain() {
    ...
    shaderGraphics.freeCommandBuffers();
    renderer.cleanupPipeline();
...
void SwapChainManager::createSwapChain() {
    VkSurfaceKHR surface = windowManager.surface;
    VkDevice device = deviceManager.device;
    ...
    QueueFamiliesManager::QueueFamilyIndices indices = queueFamiliesManager.findQueueFamilies(physicalDevice, surface);
...
uint32_t SwapChainManager::getSwapChainImageCount(const SwapChainSupportDetails &swapChainSupport) {
...
void SwapChainManager::createImageViews() {
    ...
    for (size_t i = 0; i < swapChainImages.size(); i++) {
        ...
        if (vkCreateImageView(deviceManager.device, &createInfo, nullptr, &swapChainImageViews[i]) != VK_SUCCESS) {
